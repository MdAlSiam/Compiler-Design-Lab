...
%token NUM ADD SUB ID ASSIGN SEMI IF LB RB LP RP EQUAL WHILE INT DOUBLE FLOAT MAIN KEYWORD FLOAT_NUM DATATYPE
%start program
%left ADD SUB

%%
program: DATATYPE MAIN LP RP LB statements RB;
    ;
